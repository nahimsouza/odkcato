 ...
 * [odkcato.yml](odkcato.yml)
     * Determines how your purl.obolibrary.org/obo/odkcato/ redirects will be handled
     ...
     * Paste in the contents of [odkcato.yml](odkcato.yml)
 ...
 * [odkcato.md](odkcato.md)
     ...
     * Paste in the contents of [odkcato.md](odkcato.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
